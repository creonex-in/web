      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-primary to-transparent from-[0%] via-[10%] rounded-full shadow-[0_0_15px_3px] shadow-primary/70 dark:shadow-primary/50"
          />
        </div>
      </div>
    </div>
